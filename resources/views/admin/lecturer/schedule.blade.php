                ...
                <div class="card-body table-responsive p-0">
                    <div class="timetable">
                        ...
                        <div class="content">
                            ...
                            @for($i = 0; $i < 6; $i++)
                                @if($lecture = App\Lecture::where('date', $newdate)->where('time', '10:00')->where('lecturer_id',\Auth::user()->id)->first())
                                    <div>
                                        <div class="accent-orange-gradient">
                                            <table class="">
                                                <tr>
                                                    <td>Группа: {{$lecture->group->name}}</td>
                                                </tr>
                                                <tr>
                            ...
                            <?php $newdate = $currentdate?>
                            @for($i = 0; $i < 6; $i++)
                                @if($lecture = App\Lecture::where('date', $newdate)->where('time', '18:00')->where('lecturer_id',\Auth::user()->id)->first())
                                    <div>
                                        <div class="accent-orange-gradient">
                                            <table class="">
                                                <tr>
