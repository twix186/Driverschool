...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.learningPlan.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.learning-plans.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('lecture_hours') ? 'is-invalid' : '' }}" type="number" name="lecture_hours" id="lecture_hours" value="{{ old('lecture_hours', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('practice_hours') ? 'is-invalid' : '' }}" type="number" name="practice_hours" id="practice_hours" value="{{ old('practice_hours', '') }}" step="1">
